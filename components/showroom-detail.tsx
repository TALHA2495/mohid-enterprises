      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mt-5 grid gap-6 lg:grid-cols-[1.02fr_1fr] lg:gap-8">
          <div className="overflow-hidden rounded-2xl border border-[#101412]/12 bg-white lg:self-start">
            ...
            {hasMultiple && (
              <div className="flex items-center gap-2 overflow-x-auto border-t border-[#101412]/10 p-3" aria-label="Product images">
                {product.images.map((url, i) => (
                  <button
                    ...
                    className={`shrink-0 overflow-hidden rounded-md border-2 transition-all ${selectedIndex === i
                      ? 'border-[#01aa3f] ring-2 ring-[#01aa3f]/20'
